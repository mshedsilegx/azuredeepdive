...
resourcegroup_name = 'xg'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'xg'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
car.price = 25000
table_service.insert_entity('itemstable', car)
print('Created entry for Peugeot 504...\n')
time.sleep(1)
...
coffee.PartitionKey = 'coffeeshop'
coffee.RowKey = '006'
coffee.brand = 'Cafe Du Monde'
coffee.flavor = 'Chicoree'
coffee.sizecup = 12
coffee.pricecup = 8
table_service.insert_entity('itemstable', coffee)
print('Created entry for Cafe Du Monde Chicoree...\n')
time.sleep(1)
